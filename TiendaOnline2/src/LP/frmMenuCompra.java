 ...
 * Mediante esta clase, el cliente, podrá elegir, que prenda desea comprar.
 */
public class frmMenuCompra extends JFrame implements ActionListener
{
	 ...
	 * En este metodo, se hace una llamada a la ventana de compra de un pantalon..
	 */
	private void Pant() 
	{		
		
		frmClienteCompraPantalon menu =new frmClienteCompraPantalon();
		menu.setVisible(true);
		
	}
	/**
	 * Metodo al que se llama cuando el suuario pulsa el boton camisetas.
	 * En este metodo, se hace una llamada a la ventana de compra de una camiseta.
	 */
	private void Cami() 
	{		
		
		frmClienteCompraCamiseta menu=new frmClienteCompraCamiseta();
		menu.setVisible(true);
	}
